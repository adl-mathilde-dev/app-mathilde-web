...
const {forwardRef,useContext,createElement,createContext,Fragment} = React__default;
...
var createStyled = function createStyled2(tag, options) {
  ...
  return function() {
    ...
    var Styled = withEmotionCache(function(props, cache, ref) {
      ...
      newProps.ref = ref;
      return /* @__PURE__ */ createElement(Fragment, null, /* @__PURE__ */ createElement(Insertion2, {
        cache,
        serialized,
...
var LegacySidebarContext = React__default.createContext(void 0);
...
var Sidebar = React__default.forwardRef(function(_a, ref) {
  ...
  return React__default.createElement(
    ...
    React__default.createElement(
      ...
      React__default.createElement(StyledSidebarContainer, { "data-testid": "".concat(sidebarClasses.container, "-test-id"), className: sidebarClasses.container, backgroundColor }, children),
...
var MenuContext = React__default.createContext(void 0);
...
var MenuFR = function(_a, ref) {
  ...
  var providerValue = React__default.useMemo(function() {
...
var MenuButtonRef = function(_a, ref) {
  ...
  if (component) {
    if (typeof component === "string") {
      return React__default.createElement(component, __assign(__assign({ className: classnames(className) }, rest), { ref }), children);
    } else {
      var _b = component.props, classNameProp = _b.className, props = __rest(_b, ["className"]);
      return React__default.cloneElement(component, __assign(__assign(__assign({ className: classnames(className, classNameProp) }, rest), props), { ref }), children);
    }
  } else {
    return React__default.createElement("a", __assign({ ref, className: classnames(className) }, rest), children);
  }
};
...
var SubMenuFR = function(_a, ref) {
  ...
  return React__default.createElement(
    ...
    React__default.createElement(
      ...
      icon && React__default.createElement(StyledMenuIcon, { rtl, className: classnames(menuClasses.icon, sharedClasses), rootStyles: getSubMenuItemStyles("icon") }, icon),
      prefix2 && React__default.createElement(StyledMenuPrefix, { collapsed, transitionDuration: sidebarTransitionDuration, firstLevel: level === 0, className: classnames(menuClasses.prefix, sharedClasses), rtl, rootStyles: getSubMenuItemStyles("prefix") }, prefix2),
      ...
      suffix && React__default.createElement(StyledMenuSuffix, { collapsed, transitionDuration: sidebarTransitionDuration, firstLevel: level === 0, className: classnames(menuClasses.suffix, sharedClasses), rootStyles: getSubMenuItemStyles("suffix") }, suffix),
      React__default.createElement(StyledExpandIconWrapper, { rtl, className: classnames(menuClasses.SubMenuExpandIcon, sharedClasses), collapsed, level, rootStyles: getSubMenuItemStyles("SubMenuExpandIcon") }, renderExpandIcon ? renderExpandIcon({
        level,
        disabled,
        active,
        open: openControlled !== null && openControlled !== void 0 ? openControlled : open
      }) : collapsed && level === 0 ? React__default.createElement(StyledExpandIconCollapsed, null) : React__default.createElement(StyledExpandIcon, { rtl, open: openControlled !== null && openControlled !== void 0 ? openControlled : open }))
    ),
    React__default.createElement(
      SubMenuContent,
...
React__default.forwardRef(SubMenuFR);
...
var MenuItemFR = function(_a, ref) {
  ...
  return React__default.createElement(
    ...
    React__default.createElement(
      ...
      icon && React__default.createElement(StyledMenuIcon, { rtl, className: classnames(menuClasses.icon, sharedClasses), rootStyles: getMenuItemStyles("icon") }, icon),
      prefix2 && React__default.createElement(StyledMenuPrefix, { collapsed, transitionDuration, firstLevel: level === 0, className: classnames(menuClasses.prefix, sharedClasses), rtl, rootStyles: getMenuItemStyles("prefix") }, prefix2),
      ...
      suffix && React__default.createElement(StyledMenuSuffix, { collapsed, transitionDuration, firstLevel: level === 0, className: classnames(menuClasses.suffix, sharedClasses), rootStyles: getMenuItemStyles("suffix") }, suffix)
    )
  );
};
